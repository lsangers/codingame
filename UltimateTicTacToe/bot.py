...
class NormalBoard:
    ...
    def play(self, move: Action, *, localize:bool = False) -> int:
        ...
        self._grid[y_coord][x_coord] = move.player
        self._moves_count += 1
...
class UltimateBoard(MonteCarloNode):
    ...
    def __init__(self, *, last_move: Action = None, parent: UltimateBoard = None) -> None:
        ...
        if parent is None:
            ...
            self._grid = deepcopy(parent._grid)
    ...
    def play(self, move: Action) -> None:
        ...
        winner = self._grid[y_grid][x_grid].play(move, localize = True)
    ...
    def _calc_winner(self) -> int:
        ...
        for index in range(3):
            ...
            if self._grid[index][0].local_winner > 0 \
                ...
                self.local_winner = self._grid[index][0].local_winner
                return self.local_winner
    ...
    def print_move(self):
        ...
        print(str(self.last_move.x_coord) + " " + str(self.last_move.y_coord))
...
for i in range(valid_action_count):
    move_row, move_col = [int(j) for j in input().split()]
